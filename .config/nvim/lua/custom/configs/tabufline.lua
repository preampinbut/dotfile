...
local function styleBufferTab(nr)
  ...
  local close_btn = "%" .. nr .. "@TbGoToBuf@   %X"
  ...
  if nr == api.nvim_get_current_buf() then
    ...
    close_btn = (vim.bo[0].modified and "%" .. nr .. "@TbGotoBuf@%#TbLineBufOnModified#  ")
    ...
    close_btn = (vim.bo[nr].modified and "%" .. nr .. "@TbGoToBuf@%#TbLineBufOffModified#  ")
